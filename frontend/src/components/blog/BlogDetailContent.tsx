        ...
        <Container>
          <div className="max-w-3xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              className="bg-primary/5 rounded-3xl p-8 border border-primary/10 mb-10"
            >
            ...
            >
              <button className="flex items-center gap-2 text-gray-500 hover:text-primary transition-colors">
                ...
                <span className="text-sm font-medium">{tCommon("shareArticle")}</span>
              </button>

              <Link href="/book-trial">
                <Button className="bg-primary hover:bg-primary/90 text-white rounded-xl px-6 py-5 font-semibold gap-2">
