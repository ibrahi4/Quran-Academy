        ...
        <div className={`grid lg:grid-cols-2 gap-12 lg:gap-20 items-center ${isRTL ? "lg:grid-flow-dense" : ""}`}>
          ...
          >
            ...
            <div className="relative">
              ...
              <div
                className={`absolute -top-4 ${isRTL ? "-right-4" : "-left-4"} w-full h-full rounded-3xl`}
                style={{
              ...
              <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-primary/10 via-primary/5 to-sand-100 aspect-[4/5] border border-sand-200/50 shadow-premium">
                ...
                {/* Decorative Corner */}
                <div className={`absolute top-0 ${isRTL ? "left-0" : "right-0"} w-24 h-24`}>
              ...
              <motion.div
                ...
                className={`absolute -bottom-4 ${isRTL ? "-left-4 md:-left-8" : "-right-4 md:-right-8"} bg-white rounded-2xl shadow-premium-hover p-5 border border-sand-200/50`}
              >
              ...
              <motion.div
                ...
                className={`absolute -top-4 ${isRTL ? "-left-4" : "-right-4"} bg-white rounded-2xl shadow-premium p-4 border border-sand-200/50 max-w-[200px]`}
              >
