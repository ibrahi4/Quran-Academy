...
export default function AdminHeader({ onMenuClick }: AdminHeaderProps) {
  ...
  // Match longest prefix (so /admin/reports doesn't match /admin)
  const matchedKey = Object.keys(pageTitles)
    .sort((a, b) => b.length - a.length)
    .find((k) => cleanPath === k || cleanPath.startsWith(k + '/'));

  const pageTitle = matchedKey ? pageTitles[matchedKey] : pageTitles['/admin'];
