...
const services = [
  { value: "quran-recitation", label: "Quran Recitation",    icon: "\ud83d\udcd6" },
  { value: "tajweed-course",   label: "Tajweed Course",       icon: "\ud83c\udfa4" },
  { value: "quran-memorization",label:"Quran Memorization",   icon: "\ud83e\udde0" },
  { value: "arabic-language",  label: "Arabic Language",      icon: "\u270d\ufe0f" },
  { value: "islamic-studies",  label: "Islamic Studies",      icon: "\ud83d\udcda" },
  { value: "kids-program",     label: "Kids Program",         icon: "\ud83e\uddd2" },
  { value: "new-muslims",      label: "New Muslims",          icon: "\ud83c\udf1f" },
];
...
function Field({
  label, icon: Icon, required, error, children, hint,
}: {
  label: string; icon?: any; required?: boolean; error?: string;
...
const inputCls = "w-full px-4 py-3 rounded-xl border border-sand-200 bg-sand-50 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/40 transition-all text-sm";
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12 bg-sand-50">
      ...
      >
        <motion.div
          ...
          className="w-24 h-24 bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-xl shadow-emerald-500/30 ring-8 ring-emerald-50"
        >
...
export default function BookTrialContent() {
  ...
  /* ── Auto-detect child mode based on age ── */
  useEffect(() => {
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-3xl p-6 md:p-10 border border-sand-200/60 shadow-premium">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-500 text-sm">Quick &amp; easy \u2014 takes less than 2 minutes</p>
              </div>
                      ...
                      <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-4">
                        <div className="flex items-start gap-2">
                          ...
                          <p className="text-xs text-emerald-800 leading-relaxed">
                            <strong>What happens next:</strong> We&apos;ll create a free account &amp; send you the setup link via email. Your first session is <strong>100% free</strong> \u2014 no payment required.
                          </p>
                        </div>
                      </div>
                    </motion.div>
